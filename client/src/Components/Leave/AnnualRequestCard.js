                    ...
                    <Accordion.Collapse eventKey="0" className="AccPart2">
                      <Card.Body>
                        <table>
                          <tbody>
                            <tr>
                              <td className="colDoc1Leave">Replacement Req:</td>
                              <td className="colDoc2Leave" colSpan="3">
                                <table>
                                  <tbody>
                                    {request.replacementRequest
                                      ? request.replacementRequest.map(
                                          (req) => {
                                            return (
                                              <tr>
                                                <td>
                                                  ...
                                                  Request sent to 
                                                  ${req.recieverName}
                                                  to replace ${req.slot.time}
                                                  Slot and the request is
                                                  ${req.status}`
                                                    : `Replacement
                                                  Request sent to 
                                                  ${req.recieverName}
                                                  to replace and the request is 
                                                  ${req.status}`}
                                                </td>
                                              </tr>
                                            )
