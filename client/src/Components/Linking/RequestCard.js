...
import '../../Stylesheets/Linking.css'
      ...
      <table>
        <tbody>
          <tr>
              ...
              <Card className="ProfileCardS">
                <table className="TextInsideProfileCardS">
                  <tbody>
                    <tr>
                      <td
                        className="ProfileCardColMidWidthLR"
                        style={{ paddingLeft: '0.5vw' }}
                      >
                        {request.staffName ? request.staffName : '-'}
                      </td>
                      <td className="ProfileCardColWidthLR">
                        {request.status ? request.status : '-'}
                      </td>
                      <td className="ProfileCardColBigWidthLR">
                        {request.slot
                          ? request.courseName +
                            ' ' +
                            request.slot.day +
            ...
            >
              {request.status === 'pending' && props.coordinator ? (
                <div>
                  <svg
