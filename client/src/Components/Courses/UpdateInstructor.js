...
export default function UpdateInstructor(props) {
  ...
  const handleDone = () => {
    ...
    if (!input.staffId) {
      setErr((prevState) => {
        return {
          ...prevState,
          staffId: 'Old Instructor is required*',
        }
      })
      ...
      setErr((prevState) => {
        return {
          ...prevState,
          newStaffId: 'New Instructor is required*',
        }
      })
    }
    axios({
      url: `${backendLink}/courseStaff/updateInstructor`,
      method: 'PUT',
      data: {
        courseId: props.id,
        ...
        <Modal.Body>
          <Form style={{ padding: '1vw' }}>
            <Form.Row style={{ paddingBottom: '1vw' }}>
              ...
              <Col>
                <Form.Label>Old Instructor*</Form.Label>
                <Form.Control
                  as='select'
                  onChange={handleINS}
                  defaultValue='Choose...'
